...
COPY --chown=101:101 index.html styles.css app.js ui.js coach.js chat.js sync.js calendar.js workout-builder.js hero-video.js metallic-button.js service-worker.js manifest.json config.js /usr/share/nginx/html/
